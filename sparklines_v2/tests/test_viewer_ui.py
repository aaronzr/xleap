...
import numpy as np
import sparklines_v2.plot.percentile_band as plotting_module
import sparklines_v2.ui.viewer as viewer_module
...
class HierarchySparklineViewerUiTests(unittest.TestCase):
    ...
    def test_measurement_pv_draws_rolling_average_without_event_markers(self):
        plt.close("all")
        hierarchy = _synthetic_hierarchy()
